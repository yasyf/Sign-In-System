 ...
 *
 * This file essentially holds no semblance to the original stock WordPress theme, I just used is out of pure laziness, so as to avoid changing any theme settings in my WP install.
 *
 * @package WordPress
